...
NAME = minishell
SRCS = main.c parsing/set_term.c parsing/set_signal.c parsing/print_picture.c parsing/parse.c parsing/set_token_type.c parsing/ft_split_index.c parsing/make_token.c parsing/set_quote.c parsing/ft_strtrim_index.c parsing/set_envp.c parsing/ft_search_envp_key.c parsing/set_cmd.c parsing/free_cmd.c parsing/ft_is_metachar.c parsing/ft_strjoin_char.c parsing/make_cmd.c parsing/delete_quote.c parsing/before_check.c parsing/ft_split_pipe.c\
...
./executor/error.c ./executor/envp.c
